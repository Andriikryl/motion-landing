...
export const Music = ({ id }: CardProps) => {
  return (
    <FeatureCard id={id} gradient="from-[#f7f0ff] to-[#e03dee]">
      <img
        className=" rounded-xl shadow-lg absolute left-[10%] top-[10%] w-[20%]"
        src="/song-1.webp"
        alt="image"
      />
      <img
        className=" rounded-xl shadow-lg absolute left-[70%] top-[20%] w-[25%]"
        src="/song-2.webp"
        alt="image"
      />
      <img
        className=" rounded-xl shadow-lg absolute left-[20%] top-[60%] w-[30%]"
        src="/song-3.webp"
        alt="image"
      />
      <div className=" absolute left-[40%] top-32 h-48 w-24 rounded-[96px] shadow-lg bg-[#1bd761] p-3 ">
